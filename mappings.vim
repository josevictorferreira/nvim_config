...
nnoremap <silent><leader>lvi :e ~/.config/nvim/settings.vim<CR>
nnoremap <silent><leader>llvi :e ~/.config/nvim/plugins.vim<CR>
nnoremap <silent><leader>lmp :e ~/.config/nvim/mappings.vim<CR>
